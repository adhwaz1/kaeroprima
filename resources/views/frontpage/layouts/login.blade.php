...
<head>
    <base href="../../../">
    <title>PT Wahana Interfood Tbk. - Login</title>
    <meta charset="utf-8" />
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                        ...
                        <a href="../../demo1/dist/index.html" class="py-9 mb-5">
                            <img alt="Logo" src="{{asset('/frontpage/assets/images/jumbotron/logo2.png')}}" class="h-60px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <a href="../../demo1/dist/authentication/layouts/aside/password-reset.html"
                                    class="link-primary fs-6 fw-bolder float-end mb-2">Forgot Password ?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Actions-->
