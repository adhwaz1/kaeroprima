    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form_add" method="post" enctype="multipart/form-data" action="{{ route('admin.product.save') }}">
                    {{ csrf_field() }}
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="default_language" role="tabpanel">
                                        <div class="fv-row py-3">
                                            ...
                                            <input type="text" name="code" class="@error('code') is-invalid @enderror form-control" placeholder="Code" value=""/>
                                            @error('code')
                                        ...
                                        <div class="fv-row py-3">
                                            ...
                                            <input type="text" name="name" class="@error('name') is-invalid @enderror form-control" placeholder="Name" value=""/>
                                            @error('name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="fv-row py-3">
                                            ...
                                            <textarea name="description" class="@error('description') is-invalid @enderror form-control" id="description"></textarea>
                                            @error('description')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="fv-row py-3">
                                            ...
                                            <input type="number" name="interest_rate" class="@error('interest_rate') is-invalid @enderror form-control" placeholder="Interest Rate" value=""/>
                                            @error('interest_rate')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="fv-row py-3">
                                            <label class="mb-5 required form-label">Calculator Simulation</label>
                                    ...
                                    <div class="tab-pane fade" id="another_language" role="tabpanel">
                                        ...
                                        <div class="fv-row py-3">
                                            ...
                                            <input type="text" name="name_an" class="@error('name_an') is-invalid @enderror form-control" placeholder="Name (an)" value=""/>
                                            @error('name_an')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="fv-row py-3">
                                            <label class="form-label required">Description (an)</label>
                                            <textarea name="description_an" class="@error('description_an') is-invalid @enderror form-control" id="Description (an)"></textarea>
                                            @error('description_an')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
