...
<style>
    ...
    #sortable .sortable-item::before{
    content: '.';
    font-size: 25px;
    line-height: 15px;
    color: #8f8f8f;
    text-shadow: 0 -8px #8f8f8f, 0 8px #8f8f8f;
    margin-right: 10px;
    }
</style>
@section('content')
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('admin.product') }}" class="text-muted text-hover-primary">Product
                        </a>
                    </li>
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="form_add" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.product.update_short') }}"
                                    ...
                                    <div class="mb-10 fv-row">
                                        <ul id="sortable">
                                            ...
                                            <li class="ui-state-default sortable-item">
                                                ...
                                                <input type="hidden" name="product[{{$key}}][short]" class="posisi" value="{{$row->short}}">
                                                <input type="hidden" name="product[{{$key}}][id]" value="{{$row->id}}">
                                            </li>
                                            @endforeach
                                          </ul>
                                    </div>
