            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed("about_us", "add"))
                                <a href="{{ route('admin.about_us.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="about-us-table">
                            <thead>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            var data_about_us = $('#about-us-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "about_us-data",
            ...
            $('#searchdatatable').keyup(function() {
                data_about_us.search($(this).val()).draw();
            });

            $('#filterstatus').change(function() {
                data_about_us.search($("#searchdatatable").val()).draw();
            })
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('admin.about_us.delete') }}",
                            data: ({
                                "_token": "{{ csrf_token() }}",
                                "_method": 'DELETE',
                                ix: ix,
                            ...
                            success: function() {
                                Swal.fire('Deleted!', 'Data has been deleted',
                                    'success');
                                data_about_us.ajax.reload(null, false);
                            }
                        });
