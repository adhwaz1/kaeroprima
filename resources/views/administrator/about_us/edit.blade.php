    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.about_us') }}" class="text-muted text-hover-primary">General</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        </li>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                @if(!empty($about_us))
                <form class="form d-flex flex-column flex-lg-row" id="form" method="post" enctype="multipart/form-data" action="{{ route('admin.about_us.update', $about_us->id) }}">
                {{ method_field('PUT') }}
                @else
                <form class="form d-flex flex-column flex-lg-row" id="form" method="post" enctype="multipart/form-data" action="{{ route('admin.about_us.insert') }}">
                @endif
                {{ csrf_field() }}
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <textarea class="ckeditor" name="description" placeholder="Description 1" rows="5" cols="40" >{{ $about_us->description }}</textarea>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    <label class="required form-label">Description 2</label>
                                    <textarea class="ckeditor" name="side_description" placeholder="Description 2" rows="5" cols="40" >{{ $about_us->side_description }}</textarea>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10"> 
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput" style="width: 100%; height: 150px;">
                                                <img src="{{asset_administrator("assets/media/about_us/$about_us->image")}}">
                                            </div>
                                            <div>
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <textarea class="ckeditor" name="goal_description" placeholder="Description" rows="5" cols="40" >{{ $about_us->goal_description }}</textarea>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="fv-row">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.about_us') }}" class="btn btn-light me-5">Cancel</a>
                            <button type="submit" id="about_us_submit" class="btn btn-primary">
...
<script src="{{ asset_administrator('assets/js/custom/apps/ecommerce/catalog/about_us.js') }}"></script>
    ...
    $(document).ready(function() {
        $('#button').on('change', function() {
            if ($("#button").is(":checked")) {
                ...
                $('#button_make').removeClass("d-none");
                $('#button_text_an').removeClass("d-none");
                $('#button_make_an').removeClass("d-none");
                $('#button_url').removeClass("d-none");
                $('#button_url_make').removeClass("d-none");
            } else {
                $('#button_text').addClass("d-none");
                $('#button_make').addClass("d-none");
                $('#button_text_an').addClass("d-none");
                $('#button_make_an').addClass("d-none");
