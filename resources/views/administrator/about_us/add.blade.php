                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <textarea class="ckeditor" name="description" placeholder="Description 1" rows="5" cols="40" ></textarea>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    <label class="required form-label">Description 2</label>
                                    <textarea class="ckeditor" name="side_description" placeholder="Description 2" rows="5" cols="40" ></textarea>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                        ...
                        <div class="card-body pt-0">
                            <div class="fv-row">
                                ...
                                <textarea class="ckeditor" name="goal_description" placeholder="Description" rows="5" cols="40" ></textarea>
                            </div>
                        </div>
                    </div>
                    </div>
