                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <input type="text" name="judul" class="form-control mb-2" placeholder="Masukan judul" value=""/>
                                </div>
                                <div class="fv-row">
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/custom/apps/ecommerce/catalog/media_library.js') }}"></script>
