            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.article') }}" class="text-muted text-hover-primary">Article</a>
                        </li>
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_add" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.article.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                               ...
                               <div class="mb-10 fv-row">
                                ...
                                <select name="category" class="form-select" data-control="select2">
                                    ...
                                    @foreach ($categories as $row)
                                        {
                                        <option value="{{ $row->id }}" {{ $row->id == $edit->post_category_id ? 'selected' : '' }}> {{ $row->name }} </option>
                                    @endforeach
                                </select>
                                <!--end::Input-->
                                <!--begin::Description-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        <label class="form-label required">Date</label>
                                            <input type="text" name="tanggal" placeholder="Date"
                                                class="form-control kt_datepicker_1 text-start" value="{{ date('d F Y', strtotime($edit->tanggal)) }}" />
                                            <div class="text-muted fs-7">
                                            </div>
                                    </div>
                                    <div class="mb-10 fv-row">
                                ...
                                <div class="tab-pane fade" id="another_language" role="tabpanel">
                                        ...
                                        <div class="d-flex">
                                            <div class="form-check form-check-custom form-check-solid form-check-sm">
                                                <input class="form-check-input" type="checkbox" id="same_as_default" name="same_as_default"
                                                   @if($edit->same_as_default == 1) checked="checked" @endif value="1" id="sameasdefault" checked/>
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <textarea name="description_an" id="description_an"
                                            class="ckeditor">{!! $edit->description_an !!}</textarea>
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">
                                        </div>
                                                ...
                                                <div class="mb-10 fv-row"> 
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput" style="width: 100%; height: 150px;">
                                                            <img src="{{asset_administrator("assets/media/icon/$edit->icon")}}">
                                                        </div>
                                                        <div>
                            ...
                            {{-- <div class="mb-10 fv-row">
                             ...
                             <div class="mb-10 fv-row">
                                <div class="form-check form-check-custom form-check-solid mb-2">
                                    <input class="form-check-input new" type="checkbox" name="flag" id="new" value="new" checked/>
                                    <label class="form-check-label" for="new">New</label>
                                    <input class="input-style" name="jenis_flag" id="jenis_flag" type="hidden" value="new" readonly>
                                </div>
                            </div>
                            <div class="mb-10 fv-row">
                                <div class="form-check form-check-custom form-check-solid mb-2">
                                    <input class="form-check-input populare" type="checkbox" name="flag" id="populare" value="populare" />
                                    <label class="form-check-label" for="populare">Populare</label>
                                </div>
                            </div>    
                             @else
                             <div class="mb-10 fv-row">
                                <div class="form-check form-check-custom form-check-solid mb-2">
                                    <input class="form-check-input new" type="checkbox" name="flag" id="new" value="new"/>
                                    <label class="form-check-label" for="new">New</label>
                                    <input class="input-style" name="jenis_flag" id="jenis_flag" type="hidden" value="new" readonly>
                                </div>
                            </div>
                            <div class="mb-10 fv-row">
                                <div class="form-check form-check-custom form-check-solid mb-2">
                                    <input class="form-check-input populare" type="checkbox" name="flag" id="populare" value="populare"  checked/>
                                    <label class="form-check-label" for="populare">Populare</label>
                                </div>
                            </div> 
                             @endif                              
                             ...
                             <div class="mb-10 fv-row">
                                <div class="d-flex">
                                    ...
                                    <label class="btn btn-outline d-flex flex-stack text-start p-6 mb-5">
                                        <div class="d-flex align-items-center me-2">
                                            <div class="form-check form-check-custom form-check-solid form-check-primary me-6">
                                                @php $ext = explode('.', $edit->data_file) @endphp
                                                <input id="upload" class="form-check-input" type="radio" name="plan" value="upload" {{ end($ext) == 'mp4' || end($ext) == 'png' || end($ext) == 'jpg' || end($ext) == 'jpeg' ? 'checked' : '' }}/>
                                            </div>
                                    ...
                                    <label class="btn btn-outline d-flex flex-stack text-start p-6 mb-5">
                                        <div class="d-flex align-items-center me-2">
                                            <div class="form-check form-check-custom form-check-solid form-check-primary me-6">
                                                <input id="embed" class="form-check-input" type="radio" name="plan" value="embed" {{ end($ext) == 'mp4' || end($ext) == 'png' || end($ext) == 'jpg' || end($ext) == 'jpeg' ? '' : 'checked' }} />
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <div class="overflow-auto py-2 bestresolution" style="display: {{ end($ext) == 'mp4' || end($ext) == 'png' || end($ext) == 'jpg' || end($ext) == 'jpeg' ? 'block' : 'none' }}">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput" style="display: {{ end($ext) == 'mp4' || end($ext) == 'png' || end($ext) == 'jpg' || end($ext) == 'jpeg' ? 'block' : 'none' }}">
                                    <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput" style="width: 100%; height: 150px;display:flex;"><img style="margin-right: auto;" src="{{asset_administrator("assets/media/news/$edit->data_file")}}"></div><div>{{$edit->data_file}}</div>
                                    <div>
                                        <a href="#" class="btn btn-light fileinput-exists" data-dismiss="fileinput">Remove</a>
                                        <span class="btn btn-light btn-file">
                                            <span class="fileinput-new">Select image or video</span>
                                            <span class="fileinput-exists">Change</span>
                                            <input type="file" name="image">
                                        </span>
                                    </div>
                                </div>
                                <input type="text" style="display: {{ end($ext) == 'mp4' || end($ext) == 'png' || end($ext) == 'jpg' || end($ext) == 'jpeg' ? 'none' : 'block' }}" name="media_link" class="fileembeded form-control mb-2" placeholder="Link Youtube" value="https://www.youtube.com/watch?v={{ end($ext) != 'mp4' && end($ext) != 'jpeg' && end($ext) != 'png' && end($ext) != 'jpg' ? $edit->data_file : '' }}" />
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="meta_title" class="form-control mb-2" placeholder="Meta Title" value="{{ $edit->meta_title }}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">
                                </div>
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea name="meta_description" id="meta_description" class="form-control mb-2 description">{{ $edit->meta_description }}</textarea>
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">
                                </div>
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/article/article.js') }}"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            document.getElementById("populare").checked = false;
            $("#jenis_flag").val("new");
             });

            $('#populare').on('change', function () {
                document.getElementById("populare").checked = true;
                document.getElementById("new").checked = false;
                $("#jenis_flag").val("populare");
            });
