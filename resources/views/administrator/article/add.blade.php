    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_add" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.article.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Main column-->
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="default_language" role="tabpanel">
                                        ...
                                        <div class="mb-10 fv-row">
                                            <label class="form-label required">Date</label>
                                                <input type="text" name="tanggal" placeholder="Date"
                                                    class="form-control kt_datepicker_1 text-start" value="" />
                                                <div class="text-muted fs-7">
                                                </div>
                                        </div>
                                        <div class="mb-10 fv-row">
                                        ...
                                        {{-- <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="url_media" class="@error('url_media') is-invalid @enderror form-control"placeholder="url_media" value="" />
                                            @error('url_media')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            <!--end::Input-->
                                        ...
                                        <div class="d-flex">
                                            <div class="form-check form-check-custom form-check-solid form-check-sm">
                                                <input class="form-check-input" type="checkbox" name="same_as_default"
                                                    value="1" id="sameasdefault" checked />
                                ...
                                {{-- <div class="mb-10 fv-row">
                                    ...
                                    <div class="mb-10 fv-row">
                                        <div class="form-check form-check-custom form-check-solid mb-2">
                                            <input class="input-style article" type="checkbox" name="flag" id="flag" value="article" />
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="meta_title" class="form-control mb-2" placeholder="Meta Title" value="" />
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">
                            </div>
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea name="meta_description" id="meta_description" class="form-control mb-2 description"></textarea>
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">
                            </div>
