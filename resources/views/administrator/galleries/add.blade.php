    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form" method="post" enctype="multipart/form-data" action="{{ route('admin.galleries.store') }}">
                    {{ csrf_field() }}
                        ...
                        <div class="card card-flush py-4">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="default_language" role="tabpanel">
                                        <div class="fv-row py-3">
                                            ...
                                            <input type="text" name="name" class="form-control mb-2" placeholder="Judul Album" value=""/>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="another_language" role="tabpanel">
                                        ...
                                        <div class="fv-row py-3">
                                            ...
                                            <input type="text" name="title_an" class="form-control mb-2" placeholder="Judul Album An" value=""/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <br><br>
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Set the gallery media gallery.</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Card header-->
                            </div>
