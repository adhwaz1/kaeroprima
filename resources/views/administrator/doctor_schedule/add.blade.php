    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.doctor_schedules') }}" class="text-muted text-hover-primary">Doctor Schedule
                            </a>
                        </li>
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_add" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.doctor_schedules.save') }}"
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select name="service" id="service" class="@error('our_service_id') is-invalid @enderror form-control" data-control="select2">
                                        ...
                                        @foreach ($our_services as $row)
                                            <option value="{{ $row->id }}"{{ request()->get('service_id') && request()->get('service_id') == $row->id ? "selected" : "" }} >  {{ $row->title }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="default_language" role="tabpanel">
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="monday" class="form-control" placeholder="Monday Schedule" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <label class="form-label">Tuesday Schedule</label>
                                            <input type="text" name="tuesday" class="form-control" placeholder="Tuesday Schedule" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <label class="form-label">Wednesday Schedule</label>
                                            <input type="text" name="wednesday" class="form-control" placeholder="Wednesday Schedule" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <label class="form-label">Thursday Schedule</label>
                                            <input type="text" name="thursday" class="form-control" placeholder="Thursday Schedule" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <label class="form-label">Friday Schedule</label>
                                            <input type="text" name="friday" class="form-control" placeholder="Friday Schedule" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <label class="form-label">Saturday Schedule</label>
                                            <input type="text" name="saturday" class="form-control" placeholder="Saturday Schedule" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <label class="form-label">Sunday Schedule</label>
                                            <input type="text" name="sunday" class="form-control" placeholder="Sunday Schedule" value="" />
                                        </div>
                                    </div>
