...
<script>
	...
	var arraydata = [];
	var add_item = '{{ route("add-director-item") }}';
	var update_item = '{{ route("update-director-item")}}';
	var generate_sort_item = '{{ route("generate-director-item") }}';
	var deleteitemmenur = '{{ route("delete-director-item") }}';
...
<script type="text/javascript" src="{{asset('js/director_list/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('js/director_list/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('js/director_list/shorting.js')}}"></script>
