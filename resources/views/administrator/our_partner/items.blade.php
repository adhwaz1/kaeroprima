					...
					<div id="wpbody-content">
						<div class="wrap">
							<div id="nav-menus-frame">
								@if(request()->has('our_partner_id') && !empty(request()->input("our_partner_id")))
								<div id="menu-settings-column" class="metabox-holder">
									<div class="clear"></div>
									<form id="nav-menu-meta" 
                                        {{-- action="{{ route('add-our-group') }}"  --}}
                                        class="nav-menu-meta" method="post" enctype="multipart/form-data">
                                        {{-- {{ csrf_field() }} --}}
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												<li class="control-section accordion-section  open add-page" id="add-page">
													<h3 class="accordion-section-title hndle" tabindex="0"> Add {{ $data->image_url }} <span class="screen-reader-text">Press return or enter to expand</span></h3>
													<div class="accordion-section-content ">
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																<p id="menu-item-title-wrap">
																	<label class="howto" for="custom-menu-item-title"> <span>Name<small style="color: red">*</small></span>&nbsp;&nbsp;&nbsp;
																		<input id="custom-menu-item-title" name="title" type="text" class="menu-item-textbox">
                                                                        <input type="hidden" name="our_group_id" id="our_group_id" value="{{ isset($id) ? $id : '' }}">
																	</label>
																</p>
                                                                {{-- <p id="menu-item-title_an-wrap">
																	<label class="howto" for="custom-menu-item-title_an"> <span>Judul An</span>&nbsp;&nbsp;&nbsp;
																		<input id="custom-menu-item-title_an" name="title_an" type="text" class="menu-item-textbox">
																	</label>
																</p> --}}
                                                                {{-- <p id="menu-item-sub_title-wrap">
																	<label class="howto" for="custom-menu-item-sub_title"> <span>Sub Judul <small style="color: red">*</small></span>&nbsp;&nbsp;&nbsp;
																		<input id="custom-menu-item-sub_title" name="sub_title" type="text" class="menu-item-textbox">
																	</label>
																</p> --}}
                                                                {{-- <p id="menu-item-sub_title_an-wrap">
																	<label class="howto" for="custom-menu-item-sub_title_an"> <span>Sub Judul An</span>&nbsp;&nbsp;&nbsp;
                                                                ...
                                                                {{-- <p id="menu-item-description-wrap">
																	<label class="howto" for="custom-menu-item-description"> <span>Deskripsi <small style="color: red">*</small></span>&nbsp;&nbsp;&nbsp;
																	</label>
                                                                ...
                                                                {{-- <p id="menu-item-description_an-wrap">
																	<label class="howto" for="custom-menu-item-description_an"> <span>Deskripsi An</span>&nbsp;&nbsp;&nbsp;
																	</label>
                                                                ...
                                                                <p class="field-css-image description description-wide" id="menu-item-image-wrap">
                                                                    <br><span>Image<small style="color: red">*</small></span>
                                                                    <div class="imgUp">
												...
												<div id="post-body">
													<div id="post-body-content">
														<ul class="menu ui-sortable" style="display: block;" id="menu-to-edit">
															@if(isset($data) && !empty($data->list_groups)) 
																	...
																	<dt class="menu-item-handle" style="border-radius: 6px; background: #dee8e9;">
																		...
																		<span class="item-title">
                                                                            <span class="menu-item-title">
                                                                                <span id="menutitletemp_{{$item->id}}"><img style="width: 100px; height: 50px;" src="{{asset_administrator("assets/media/items/$item->image")}}"></span>
																...
																<div class="menu-item-settings" data-id="{{$item->id}}" id="menu-item-settings-{{$item->id}}">
                                                                    ...
                                                                    <form id="form-edit-{{$item->id}}" data-id="{{ $item->id }}" class="form-edit" method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <p class="description description-thin">
                                                                            <label for="title_{{$item->id}}"> Name <small style="color: red">*</small>
                                                                                <br>
                                                                        ...
                                                                        <p class="description description-thin">
                                                                            <label for="sub_title_{{$item->id}}"> Sub Title <small style="color: red">*</small>
                                                                                <br>
                                                                        ...
                                                                        <p class="description description-thin">
                                                                            <label for="sub_title_an_{{$item->id}}"> Sub Title An
                                                                                <br>
                                                                        ...
                                                                        {{-- <p class="field-css-url description description-wide">
                                                                            <label for="description_{{$item->id}}"> Deskripsi <small style="color: red">*</small>
                                                                                <br>
                                                                        ...
                                                                        {{-- <p class="field-css-url description description-wide">
                                                                            <label for="description_an_{{$item->id}}"> Deskripsi An
                                                                                <br>
