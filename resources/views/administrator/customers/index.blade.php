                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed("customers", "add"))
                                <a href="{{ route('admin.customers.add') }}" class="btn btn-sm btn-light-primary">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="customer-table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px">Customer Group</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            var data_customers = $('#customer-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "customers-data",
            ...
            $('#searchdatatable').keyup(function() {
                data_customers.search($(this).val()).draw();
            });

            $('#filterstatus').change(function() {
                data_customers.search($("#searchdatatable").val()).draw();
            })
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                Swal.fire('Deleted!', 'Data has been deleted',
                                    'success');
                                data_customers.ajax.reload(null, false);
                            }
                        });
