    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form" method="post" enctype="multipart/form-data" action="{{ route('admin.customers.insert') }}">
                    {{ csrf_field() }}
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/custom/apps/ecommerce/catalog/customers.js') }}"></script>
