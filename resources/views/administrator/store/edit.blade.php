                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" value="{{ $store->name }}" name="name" class="form-control mb-2" placeholder="Nama Store" value="" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="form-label">Email</label>
                                    <input type="email" value="{{ $store->email }}" name="email" class="form-control mb-2" placeholder="Email" value="" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="form-label">No Telphone / HP</label>
                                    <input type="text" value="{{ $store->phone }}" name="phone" class="form-control mb-2" placeholder="No Telphone / HP" value="" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <textarea name="detail_address" id="detail_address" class="form-control mb-2">{{ $store->detail_address }}</textarea>
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" id="status" name="status" {{ $store->status == 1 ? 'checked="checked"' : '' }} />
