                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed("users", "add"))
                                <a href="{{ route('admin.users.add') }}" class="btn btn-sm btn-light-primary">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px">User Group</th>
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data_user_group = $('#kt_ecommerce_products_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
            ...
            $('#searchdatatable').keyup(function() {
                data_user_group.search($(this).val()).draw();
            })

            $('#filterstatus').change(function() {
                data_user_group.search($("#searchdatatable").val()).draw();
            })
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                Swal.fire('Deleted!', 'Data has been deleted',
                                    'success');
                                data_user_group.ajax.reload(null, false);
                            }
                        });
