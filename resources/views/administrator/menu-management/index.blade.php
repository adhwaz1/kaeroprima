...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            var data_menu_management = $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: url,
            ...
            $('#searchdatatable').keyup(function() {
                data_menu_management.search($(this).val()).draw();
            })
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ url('admin/menu-management/delete') }}",
                            data: ({
                                "_token": "{{ csrf_token() }}",
                                "_method": 'DELETE',
                                ix: ix,
                            ...
                            success: function() {
                                Swal.fire('Deleted!', 'Data has been deleted',
                                    'success');
                                data_menu_management.ajax.reload(null, false);
                            },
