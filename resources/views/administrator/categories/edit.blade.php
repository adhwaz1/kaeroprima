        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_add" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.categories.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select name="parent" class="form-select" data-control="select2">
                                        ...
                                        @foreach ($categories as $row) {
                                            <option value="{{ $row->id }}"
                                                {{ $row->id == $edit->parent ? 'selected' : '' }}> {{ $row->name }} </option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput"
                                            ...
                                            <img src="{{img_src($edit->image, "category") }}">
                                        </div>
                                        <div>
