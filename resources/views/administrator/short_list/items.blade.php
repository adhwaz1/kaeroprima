					...
					<div id="wpbody-content">
						<div class="wrap">
							<div id="nav-menus-frame">
								@if(request()->has('short_list_id') && !empty(request()->input("short_list_id")))
															...
															<div class="customlinkdiv" id="customlinkdiv">
																<p id="menu-item-title-wrap">
																	<label class="howto" for="custom-menu-item-title"> <span>Title <small style="color: red">*</small></span>&nbsp;&nbsp;&nbsp;
                                                                        ...
                                                                        <input type="hidden" name="short_list_id" id="short_list_id" value="{{ isset($id) ? $id : '' }}">
																	</label>
																</p>
                                                                ...
                                                                <p id="menu-item-sub_title-wrap">
                                                                    <label class="howto" for="custom-menu-item-sub_title">
                                                                        <span>Code <small style="color: red">*</small></span>&nbsp;&nbsp;&nbsp;
                                                                ...
                                                                <p id="menu-item-description-wrap">
																	<label class="howto" for="custom-menu-item-description"> <span>Description&nbsp;&nbsp;&nbsp;
																	</label>
											...
											<div class="menu-edit ">
												...
												<div id="post-body">
                                                            ...
                                                            <li id="menu-item-{{$item->id}}" class="menu-item menu-item-depth-{{$item->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" data-id="{{$item->id}}" id="menu-item-settings-{{$item->id}}">
                                                                    ...
                                                                    <form id="form-edit-{{$item->id}}" data-id="{{ $item->id }}" class="form-edit" method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <p class="description description-thin">
                                                                            <label for="sub_title_{{$item->id}}"> Code <small style="color: red">*</small>
                                                                                <br>
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        <a href="{{ route('short-list.index') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-secondary me-5">Cancel</a>
                                                        </button>
                                                    </div>
												</div>
											</div>
