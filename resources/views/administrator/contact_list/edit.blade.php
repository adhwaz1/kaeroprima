            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.contact_list') }}" class="text-muted text-hover-primary">Contact List</a>
                        </li>
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_add" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.contact_list.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select name="service" class="@error('service') is-invalid @enderror form-control" data-control="select2 value="{{ $edit->name }}">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="name" class="form-control mb-2" placeholder="Name" value="{{ $edit->name }}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">
                                            </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="required form-label">No WhatsApp</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="whatsapp_number" class="form-control mb-2" placeholder="No WhatsApp" value="{{ $edit->whatsapp_number }}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">
                                            </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="instagram" class="form-control mb-2" placeholder="Masukan Link Instagram" value="{{ $edit->instagram }}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">
                                            </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="location" class="form-control mb-2" placeholder="Cabang" value="{{ $edit->location }}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">
                                            </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('admin.contact_list') }}" id="kt_ecommerce_add_product_cancel"
                                class="btn btn-light me-5">Cancel</a>
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button type="submit" id="contact_list_submit" class="btn btn-primary">
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/contact_list/contact_list.js') }}"></script>
