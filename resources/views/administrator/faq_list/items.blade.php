					...
					<div id="wpbody-content">
						<div class="wrap">
							<div id="nav-menus-frame">
								@if(request()->has('faq_list_id') && !empty(request()->input("faq_list_id")))
														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																<p id="menu-item-title-wrap">
																	<label class="howto" for="custom-menu-item-title"> <span>Question <small style="color: red">*</small></span>&nbsp;&nbsp;&nbsp;
																		<input id="custom-menu-item-title" name="title" type="text" class="menu-item-textbox">
                                                                        <input type="hidden" name="faq_list_id" id="faq_list_id" value="{{ isset($id) ? $id : '' }}">
																	</label>
																</p>
                                                                {{-- <p id="menu-item-title_an-wrap">
																	<label class="howto" for="custom-menu-item-title_an"> <span>Question An</span>&nbsp;&nbsp;&nbsp;
                                                                ...
                                                                <p id="menu-item-description-wrap">
																	<label class="howto" for="custom-menu-item-description"> <span>Answer <small style="color: red">*</small></span>&nbsp;&nbsp;&nbsp;
																	</label>
                                                                ...
                                                                {{-- <p id="menu-item-description_an-wrap">
																	<label class="howto" for="custom-menu-item-description_an"> <span>Answer An</span>&nbsp;&nbsp;&nbsp;
																	</label>
