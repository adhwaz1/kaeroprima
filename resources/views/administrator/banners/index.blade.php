            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Banners</li>
                    </ul>
                </div>
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed("banners", "add"))
                                <a href="{{ route('admin.banners.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="banner-table">
                            <thead>
...
<script> type="text/javascript">
        $(document).ready(function() {
            ...
            var data_banners = $('#banner-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.banners.getData') }}',
                    dataType: "JSON",
                    type: "GET",
                    data:function(d){
                        d.status = getStatus();
                ...
                columns: [
                    ...
                    //         return row.description.replace(/<p>|<\/p>/g, "");
                    //     }
                    // },
                    {
                        "render": function(data, type, row) {
            ...
            $('#searchdatatable').keyup(function() {
                data_banners.search($(this).val()).draw();
            });

            $('#filterstatus').change(function() {
                data_banners.search($("#searchdatatable").val()).draw();
            })
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                Swal.fire('Deleted!', 'Data has been deleted',
                                    'success');
                                data_banners.ajax.reload(null, false);
                            }
                        });
        ...
        $(document).on('click', '.changeStatus', function (event) {
            var ix = $(this).data('ix');
            var currentStatus = $(this).is(':checked') ? "inactive" : "active";

            Swal.fire({
                html: 'Are you sure change status to ' + (currentStatus === "active" ? "inactive" : "active") + '?',
                icon: "info",
                buttonsStyling: false,
                showCancelButton: true,
                confirmButtonText: "Ok, got it!",
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.banners.changeStatus') }}",
                        data: ({
                            "_token": "{{ csrf_token() }}",
                            ix: ix,
                        ...
                        success: function () {
                            ...
                            if (currentStatus === "active") {
                                ...
                                $('.changeStatus').not(this).prop("checked", false);
                            }
                            // Check if the current status is inactive
                            else {
                    ...
                    // Revert the checkbox state based on the current status
                    $(this).prop("checked", currentStatus === "active");
                }
            });
        });
