    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form_add" method="post" enctype="multipart/form-data" action="{{ route('admin.banners.insert') }}">
                    {{ csrf_field() }}
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="default_language" role="tabpanel">
                                        <div class=" py-4">
                                            <label class="fv-row form-label">Title</label>
                                            <input type="text" name="title" class="form-control mb-2" placeholder="Title" value=""/>
                                        </div>
                                        {{-- <div class=" py-4">
                                            <label class="form-label">Caption</label>
                                            <input type="text" name="caption" class="form-control mb-2" placeholder="Caption" value=""/>
                                        </div> --}}
                                        <div class=" py-4">
                                        ...
                                        <div class=" py-4">
                                            ...
                                            <div class="form-check form-switch form-check-custom form-check-solid">
                                                <input class="form-check-input" id="button" type="checkbox" value="1" id="show_button" name="show_button" checked="checked" />
                                                <label class="form-check-label fw-bold text-gray-400 ms-3" for="show_button">Show</label>
                                            </div>
                                        </div>
                                        <div class="fv-body py-4" id="button_text_get">
                                            <label class="form-label">Button 1</label>
                                            <input type="text" name="button_text_get" class="form-control" placeholder="Button 1" value=""/>
                                        </div>
                                        <div class="fv-body py-4" id="button_url">
                                            <label class="form-label">URL 1</label>
                                            <input type="text" name="button_url" class="form-control" placeholder="URL 1" value=""/>
                                        </div>
                                        {{-- <div class="fv-body py-4" id="button_text_make">
                                            <label class="form-label">Button 2</label>
                                            <input type="text" name="button_text_make" class="form-control" placeholder="Button 2" value=""/>
                                        </div>
                                        <div class="fv-body py-4" id="button_url_make">
                                            <label class="form-label">URL 2</label>
                                            <input type="text" name="button_url_make" class="form-control" placeholder="URL 2" value=""/>
                                        </div> --}}
                                    </div>
                                    <div class="tab-pane fade" id="another_language" role="tabpanel">
                                        <div class="form-check form-check-custom form-check-solid py-4">
                                            <input class="form-check-input" type="checkbox" value="1" id="status" name="same_as_default" checked="checked" />
                                        ...
                                        <div class="fv-row py-4">
                                            ...
                                            <input type="text" name="title_an" class="form-control mb-2" placeholder="Title An" value=""/>
                                        </div>
                                        {{-- <div class="fv-row py-4">
                                            <label class="form-label">Caption An</label>
                                            <input type="text" name="caption_an" class="form-control mb-2" placeholder="Caption An" value=""/>
                                        </div> --}}
                                        <div class="fv-row py-4">
                                            <label class="form-label">Description An</label>
                                            <textarea class="form-control" name="description_an" placeholder="Description An"></textarea>
                                        </div>
                                        {{-- <div class="fv-row py-4" id="button_text_an">
                                            <label class="form-label">Button Text An</label>
                                            <input type="text" name="button_text_an" class="form-control" placeholder="Button Text An" value=""/>
                                        </div> --}}
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                ...
                                <div class="fv-row fileinput fileinput-new" data-provides="fileinput">
