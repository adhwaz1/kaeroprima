    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form_add" method="post" enctype="multipart/form-data" action="{{ route('admin.testimonials.insert') }}">
                    {{ csrf_field() }}
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="default_language" role="tabpanel">
                                        ...
                                        <div class="fv-row py-4">
                                            ...
                                            <input type="text" name="customer_position" class="form-control mb-2" placeholder="title" value=""/>
                                        </div>
                                        <div class="fv-row py-4">
                                            <label class="required form-label">Description</label>
                                            <textarea class="ckeditor" id="testimoni" name="testimoni" placeholder="Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="overflow-auto py-2">
                                    ...
                                    <label class="required form-label mt-2">Image</label>
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.testimonials') }}" class="btn btn-light me-5">Cancel</a>
