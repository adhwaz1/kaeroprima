    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Job Title</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.testimonials') }}" class="text-muted text-hover-primary">Job Title</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        </li>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form_add" method="post" enctype="multipart/form-data" action="{{ route('admin.testimonials.update', $testimonials->id) }}">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="default_language" role="tabpanel">
                                        <div class="fv-row py-4">
                                            ...
                                            <input type="text" name="name" class="form-control mb-2" placeholder="Name" value="{{ $testimonials->name }}"/>
                                        </div>
                                        <div class="fv-row py-4">
                                            <label class="required form-label">title</label>
                                            <input type="text" name="customer_position" class="form-control mb-2" placeholder="Job title" value="{{ $testimonials->customer_position }}"/>
                                        </div>
                                        <div class="fv-row py-4">
                                            <label class="required form-label">Description</label>
                                            <textarea class="ckeditor" id="testimoni" name="testimoni" placeholder="Description">{{ $testimonials->testimoni }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pt-0">   
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-preview thumbnail mb20" data-trigger="fileinput"
                                        style="width: 100%; height: 150px;"><img src="{{asset_administrator("assets/media/testimonials/$testimonials->image")}}"></div>
                                    <div>
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" id="status" name="status" @if($testimonials->status == 1) checked="checked" @endif />
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.testimonials') }}" id="kt_ecommerce_add_customer_cancel" class="btn btn-light me-5">Cancel</a>
                            <button type="submit" id="testimonial_submit" class="btn btn-primary">
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/custom/testimonials.js') }}"></script>
