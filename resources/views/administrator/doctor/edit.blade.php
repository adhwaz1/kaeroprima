    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Doctor</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.doctors') }}" class="text-muted text-hover-primary">Doctor</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        </li>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form" method="post" enctype="multipart/form-data" action="{{ route('admin.doctors.update', $doctors->id) }}">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    <label class="required form-label">Name Doctor</label>
                                    <input type="text" name="name" class="form-control mb-2" placeholder="Name Doctor" value="{{ $doctors->name }}"/>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    <label class="required form-label">Image</label>
                                    <input type="file" name="photo" class="form-control mb-2" value="" />
                                </div>
                                ...
                                <div class="row col-md-6">
                                    <img class="rounded-circle" style="height: 200px; width: 210px;" src="{{asset_administrator("assets/media/doctor/$doctors->photo")}}" />
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" id="status" name="status" @if($doctors->status == 1) checked="checked" @endif />
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.doctors') }}" class="btn btn-light me-5">Cancel</a>
                            <button type="submit" id="edit_doctor_submit" class="btn btn-primary">
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/doctor/edit_doctor.js') }}"></script>
