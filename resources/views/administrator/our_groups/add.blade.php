    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.our_groups.store') }}">
                    {{ csrf_field() }}
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <input type="text" name="name" class="form-control mb-2" placeholder="Name Our Group" value=""/>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="fv-row">
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" id="status" name="status" checked="checked" /><br>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.our_groups') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
                            <button type="submit" id="our_group_submit" class="btn btn-primary">
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/custom/apps/ecommerce/catalog/our_groups.js') }}"></script>
