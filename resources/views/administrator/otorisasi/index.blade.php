        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Otorisasi</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Otorisasi</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                {{-- @if (isAllowed("our-partner", "add")) --}}
                                {{-- <a href="{{ route('our-partner.add') }}" class="btn btn-sm btn-light-primary">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-150px">Partner</th>
...
@push('scripts')
    <script>
        let url = `{!! route('otorisasi.getData') !!}`;
        $(document).ready(function() {
            var data_customer_partner = $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: url,
            ...
            $('#searchdatatable').keyup(function() {
                data_customer_partner.search($(this).val()).draw();
            })
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ url('admin/otorisasi/delete') }}",
                            data: ({
                                "_token": "{{ csrf_token() }}",
                                "_method": 'DELETE',
                                ix: ix,
                            ...
                            success: function() {
                                Swal.fire('Deleted!', 'Data has been deleted',
                                    'success');
                                data_customer_partner.ajax.reload(null, false);
                            },
