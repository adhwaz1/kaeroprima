            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed("customer_groups", "add"))
                                <a href="{{ route('admin.customer_group.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="customer-group-table">
                            <thead>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            var data_customer_group = $('#customer-group-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "customer_group-data",
                    dataType: "JSON",
                    type: "GET",
                    data:function(d){
                        d.status = getStatus();
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return "<a href='customer_group/detail/"+row.id+"' class='text-gray-800 text-hover-primary fs-5 fw-bolder'>"+row.name+"</a>"
                        },
                    },
                    {
                        render: function(data, type, row) {
            ...
            $('#searchdatatable').keyup(function() {
                data_customer_group.columns(1).search($(this).val()).draw();
            })

            $('#filterstatus').change(function() {
                data_customer_group.search($("#searchdatatable").val()).draw();
            })
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('admin.customer_group.delete') }}",
                            data: ({
                                "_token": "{{ csrf_token() }}",
                                "_method": 'DELETE',
                                ix: ix,
