            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.bank_accounts') }}" class="text-muted text-hover-primary">Bank
                                Accounts</a>
                        </li>
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_add" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.bank_accounts.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Main column-->
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="bank_name" class="@error('bank_name') is-invalid @enderror form-control" placeholder="Bank name"
                                        value="" />
                                        @error('bank_name')
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="account_number" class="@error('account_number') is-invalid @enderror form-control" placeholder="Account number"
                                        value="" />
                                ...
                                <!--end::Input group-->
                                 ...
                                 <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">Account Owner</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="account_owner" class="@error('account_owner') is-invalid @enderror form-control" placeholder="Account Owner"
                                        value="" />
                                        @error('account_owner')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('admin.bank_accounts') }}" id="kt_ecommerce_add_product_cancel"
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/custom/bank_accounts.js') }}"></script>
