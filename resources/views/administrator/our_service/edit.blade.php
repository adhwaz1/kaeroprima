                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="default_language" role="tabpanel">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="title" class="form-control mb-2" placeholder="Name Service" value="{{ $edit->title }}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="sub_title" class="form-control mb-2" placeholder="Caption Service" value="{{ $edit->sub_title }}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">
                                            </div>
                                        ...
                                        {{-- <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="service_contact" class="form-control mb-2" placeholder="Contact " value="{{ $edit->service_contact }}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">
                                            </div>
                                        ...
                                        <div class="mb-10 fv-row color">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" id="bg-color" name="color" class="form-control mb-2" placeholder="Background Color " value="{{ $edit->color }}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">
                                            </div>
                                        ...
                                        <div id="product_media">
                                            ...
                                            <div class="image-list image-input image-input-outline mr-5"
                                                ...
                                                style="background-image: url('{{ img_src($edit->image, 'our_service') }}')">
                                                ...
                                                <div>
                                                    {{-- <button type="button" data-ix="{{ $edit->id }}" class="btn btn-light fileinput-exists image-delete" data-dismiss="fileinput">
                                                        Remove
                                                    </button> --}}
                                                    <span class="btn btn-light btn-file">
                                                        ...
                                                        <input type="hidden" name="image_id" value="{{ $edit->id }}">
                                    ...
                                    <div id="product_media">
                                            ...
                                            <div class="image-list image-input image-input-outline mr-5"
                                                data-kt-image-input="true"
                                                style="background-image: url('{{ img_src($edit->image_banner, 'our_service') }}')">
                                                <!--begin::Image preview wrapper-->
                                                <div class="image-input-wrapper w-200px h-200px"
                                                    style="background-image: url('{{ img_src($edit->image_banner, 'our_service') }}')">
                                                </div>
                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="card-toolbar">
                                                    <button type="button" data-repeater-delete=""
                                                        class="btn btn-sm btn-icon btn-light-danger delete" data-ix="{{ $item->id }}">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <input type="hidden"
                                                                ...
                                                                placeholder="ID" value="{{ $item->id }}" />

                                                            <input type="text"
                                                                name="items[{{ $index }}][title]"
                                                                class="form-control variant-sku mb-2"
                                                                placeholder="Sub Service" value="{{ $item->title }}" />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                    ...
                                                    <div id="product_media">
                                                        ...
                                                        <div class="image-list image-input image-input-outline mr-5"
                                                            data-kt-image-input="true"
                                                            style="background-image: url('{{ img_src($item->image, 'our_service_item') }}')">
                                                            <!--begin::Image preview wrapper-->
                                                            <div class="image-input-wrapper w-200px h-200px"
                                                                style="background-image: url('{{ img_src($item->image, 'our_service_item') }}')">
                                                            </div>
                                                            <!--end::Image preview wrapper-->
                                                            <div>
                                                                {{-- <button type="button" data-ix="{{ $item->id }}" class="btn btn-light fileinput-exists image-delete" data-dismiss="fileinput">
                                                                    Remove
                                                                </button> --}}
                                                                <span class="btn btn-light btn-file">
                                                                    <span class="fileinput-exists">
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <!--begin::Input-->
                                                        <div class="form-check form-switch form-check-custom form-check-solid">
                                                            <input class="form-check-input" type="checkbox" value="1" id="status" name="items[{{ $index }}][status]" {{ $item->status ? 'checked="checked"' : '' }} />
