    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form_add" method="post" enctype="multipart/form-data" action="{{ route('admin.pages.insert') }}">
                    {{ csrf_field() }}
                        ...
                        <div class="card card-flush py-4">
                                    ...
                                    <div class="tab-pane fade" id="another_language" role="tabpanel">
                                        <div class="form-check form-check-custom form-check-solid form-check-sm">
                                            <input class="form-check-input" type="checkbox" name="same_as_default"
                                                value="1" id="sameasdefault" checked="checked"/>
                                        ...
                                        <div class="fv-row py-3">
                                            ...
                                            <input type="text" name="title_an" class="form-control mb-2" placeholder="Title" value=""/>
                                        </div>
                                        <div class="fv-row py-3">
                                            <label class="form-label required">Description (An)</label>
                                            <textarea name="description_an" class="description_an" id="description_an"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <input type="text" name="url_media" class="form-control mb-2" placeholder="URL Media" value=""/>
                                </div>
                            </div>
                            <div class="card-body pt-0">
