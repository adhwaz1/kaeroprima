            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed("pages", "add"))
                                <a href="{{ route('admin.pages.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="pages-table">
                            <thead>
...
<script src="{{ asset_administrator('assets/plugins/custom/jstree/jstree.bundle.js') }}"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data_pages = $('#pages-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
            ...
            $('#searchdatatable').keyup(function() {
                data_pages.search($(this).val()).draw();
            });

            $('#filterstatus').change(function() {
                data_pages.search($("#searchdatatable").val()).draw();
            })
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                Swal.fire('Deleted!', 'Data has been deleted',
                                    'success');
                                data_pages.ajax.reload(null, false);
                            }
                        });
