...
{
    private static $module = "about_us";
    ...
    public function index()
    {
        ...
        if(empty($about_us)){
            return view('administrator.about_us.add');
        }else{
            return view('administrator.about_us.edit', compact('about_us'));
        }
    ...
    public function add(){
        ...
        return view('administrator.about_us.add', compact('about_us')); 
    }
    ...
    public function insert(Request $request){
    	...
    	return redirect('/admin/about_us')->with(['success' => 'Your data added successfully.']);
    }
    ...
    public function edit(){
        ...
        $about_us = AboutUs::first();
        return view('administrator.about_us.edit', ['about_us' => $about_us]);
    }
    ...
    public function update($id, Request $request)
    {
        ...
        $about_us->side_description = $request->side_description;
        $about_us->goal_description = $request->goal_description;
        $about_us->status          = $status;

        if($request->image != ''){
            if(file_exists('./administrator/assets/media/about_us/'.$about_us->image) && $about_us->image != null){
                $file_old = './administrator/assets/media/about_us/'.$about_us->image;
                unlink($file_old);
            }
        ...
        return redirect('/admin/about_us')->with(['success' => 'Your data updated successfully.']);
    }
    ...
    public function delete(Request $request)
    {
        ...
        if (!empty($about_us->image)) {
            $image_path = "./administrator/assets/media/about_us/".$about_us->image;
