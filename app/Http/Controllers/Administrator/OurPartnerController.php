...
class OurPartnerController extends Controller
{
    ...
    private static $module = "our_partners";

    // Sort Parent
    public function index() {
        return view('administrator.our_partner.index');
    }
    ...
    public function getData(Request $request) {
        ...
        ->addColumn('action', function($row){
            ...
            abort(403);
            $btn .= '<a href="'.route('our-partner.detail','our_partner_id='.$row->id).'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
    ...
    public function create() {
        ...
        return view('administrator.our_partner.add');
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            return redirect()->route('our-partner.index')->with('success', $request->name.' berhasil ditambahkan');
        } catch (\Throwable $th) {
            return redirect()->route('our-partner.index')->with('error', 'Terjadi kesalahan. Tidak dapat menambahkan data Sort Item.');
        }
    }
    ...
    public function show(Request $request) {
        ...
        try {
            if(!isset($request->our_partner_id))
                return redirect()->route('our-partner.index')->with('error', 'Menu tidak tersedia atau telah dihapus');
            ...
            return view('administrator.our_partner.detail', compact('data', 'id'));
        } catch (\Throwable $th) {
            return redirect()->route('our-partner.index')->with('error', 'Terjadi kesalahan. Tidak dapat menampilkan data Sort Item.');
        }
    }
    ...
    public function edit($id) {
        ...
        try {
            ...
            return view('administrator.our_partner.edit', compact('data'));
        } catch (\Throwable $th) {
            return redirect()->route('our-partner.index')->with('error', 'Terjadi kesalahan. Tidak dapat menampilkan data Sort Item.');
        }
    }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            return redirect()->route('our-partner.index')->with('success', 'Data berhasil dirubah');
        } catch (\Throwable $th) {
            return redirect()->route('our-partner.index')->with('error', 'Terjadi kesalahan. Tidak dapat mengubah data Sort Item.');
        }
    }
