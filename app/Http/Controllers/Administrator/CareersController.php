...
class CareersController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->status != "") {
            ...
            $data = $query->where("careers.status", $status)->get();
        } else {
            $data = $query->get();
        }
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                ...
                $btn .= '<a href="' . route('admin.career.edit', $row->id) . '" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
    ...
    public function add()
    {
        ...
        $categories = CareerCategory::where("career_categories.status", 1)->get();
        $paths      = CareerPath::where("career_paths.status", 1)->get();

        return view("administrator.career.add", compact("categories", "paths"));
    }
    ...
    public function save(Request $request)
    {
        ...
        //Write log
        createLog(static::$module, __FUNCTION__, $career->id);
    ...
    public function edit($id)
    {
        ...
        return view("administrator.career.edit", compact("categories", "paths", "edit"));
    }
    ...
    public function update(Request $request)
    {
        ...
        $career = Career::where('id', $id)->update($data);
    ...
    public function delete(Request $request)
    {
        ...
        $id = $request->ix;
        $categories = Career::find($id);
        $data = Career::destroy($request->ix);
    ...
    public function isExist(Request $request)
    {
        ...
        $career = Career::where("title", $title);
        if ($request->id) {
            $career->where("id", '!=', $id);
        }
